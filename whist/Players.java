 ...
 private Optional<Integer> playRound() {  // Returns winner, if any
	...
	for (int i = 0; i < GameInformation.nbStartCards; i++) {
        ...
        if (GameInformation.players.get(nextPlayer) == "Player") {  // Select lead depending on player type
			...
			selected = PlayersMode.NPCSelection(GameInformation.hands[nextPlayer],lead,trumps);
			...
			selected = PlayersMode.SmartSelection(GameInformation.hands[nextPlayer],lead,trumps,hasTrumpOnBoard,winningCard,largestTrump);
